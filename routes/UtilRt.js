...
/* send email from cros */
router.post('/mail', function(req, res, next) {

  // read mail data
  var mailData = {
    from: req.body.fromAddress === undefined ? 'osavmail@gmail.com' : req
      .body.fromAddress,
    to: req.body.emailto,
    cc: req.body.cclist,
    replyTo: req.body.fromAddress === undefined ?
      'christinachenjy@gmail.com' : req.body.fromAddress,
